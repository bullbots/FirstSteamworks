...
//    	setDefaultCommand(new DriveOneWheel());
    ...
    public void drive(double x, double y, double z) {
    	...
    	chassis.mecanumDrive_Cartesian(x, y, gyroCorrection, gyro);
    }
...
//    	SmartDashboard.putNumber("Joystick Z", driverJoy.getZ());
    ...
    {
    	drive(deadBand(driverJoy.getX(),0.1),deadBand(driverJoy.getY(),0.1),indexInput(deadBand(driverJoy.getZ(),0.6),0.6));
    }
