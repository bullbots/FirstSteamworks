...
public class DriveOneWheel extends Command {
	...
	private int wheel;
	private static final double power = 2000;
    ...
    protected void execute() {
    	...
    	SmartDashboard.putNumber("FrontLeftSpeed", Robot.driveSystem.getFrontLeftWheelFeedback());
    	SmartDashboard.putNumber("RearLeftSpeed", Robot.driveSystem.getRearLeftWheelFeedback());
    	SmartDashboard.putNumber("FrontRightSpeed", Robot.driveSystem.getFrontRightWheelFeedback());
    	SmartDashboard.putNumber("RearRightSpeed", Robot.driveSystem.getRearRightWheelFeedback());
